  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_calendar_novo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendar_calendar_novo_form();
	}

  // ---------- Validate title
  function do_ajax_calendar_calendar_novo_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_calendar_novo_validate_title(var_title, var_script_case_init, do_ajax_calendar_calendar_novo_validate_title_cb);
  } // do_ajax_calendar_calendar_novo_validate_title

  function do_ajax_calendar_calendar_novo_validate_title_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendar_novo_validate_title_cb

  // ---------- Validate start_time
  function do_ajax_calendar_calendar_novo_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_calendar_novo_validate_start_time(var_start_time, var_script_case_init, do_ajax_calendar_calendar_novo_validate_start_time_cb);
  } // do_ajax_calendar_calendar_novo_validate_start_time

  function do_ajax_calendar_calendar_novo_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendar_novo_validate_start_time_cb

  // ---------- Validate hora
  function do_ajax_calendar_calendar_novo_validate_hora()
  {
    var nomeCampo_hora = "hora";
    var var_hora = scAjaxGetFieldText(nomeCampo_hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_calendar_novo_validate_hora(var_hora, var_script_case_init, do_ajax_calendar_calendar_novo_validate_hora_cb);
  } // do_ajax_calendar_calendar_novo_validate_hora

  function do_ajax_calendar_calendar_novo_validate_hora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendar_novo_validate_hora_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_calendar_calendar_novo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_calendar_novo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_calendar_calendar_novo_submit_form(var_title, var_start_time, var_hora, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_calendar_novo_submit_form_cb);
  } // do_ajax_calendar_calendar_novo_submit_form

  function do_ajax_calendar_calendar_novo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_calendar_novo_submit_form_cb_after_alert);
  } // do_ajax_calendar_calendar_novo_submit_form_cb
  function do_ajax_calendar_calendar_novo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_calendar_novo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_calendar_novo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_calendar_calendar_novo_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_calendar_novo_navigate_form_cb);
  } // do_ajax_calendar_calendar_novo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_novo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_calendar_novo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_calendar_novo_navigate_form_cb_after_alert);
  } // do_ajax_calendar_calendar_novo_navigate_form_cb
  function do_ajax_calendar_calendar_novo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_calendar_novo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_calendar_novo_navigate_form_cb_after_alert
  function sc_hide_calendar_calendar_novo_form()
  {
