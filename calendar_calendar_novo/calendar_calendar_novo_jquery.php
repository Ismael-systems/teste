...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_title' + iSeqRow).bind('blur', function() { sc_calendar_calendar_novo_title_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_calendar_calendar_novo_title_onfocus(this, iSeqRow) });
  $('#id_sc_field_start_time' + iSeqRow).bind('blur', function() { sc_calendar_calendar_novo_start_time_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_calendar_calendar_novo_start_time_onfocus(this, iSeqRow) });
  $('#id_sc_field_hora' + iSeqRow).bind('blur', function() { sc_calendar_calendar_novo_hora_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_calendar_calendar_novo_hora_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_calendar_calendar_novo_hora_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_calendar_calendar_novo_title_onblur(oThis, iSeqRow) {
  do_ajax_calendar_calendar_novo_validate_title();
  scCssBlur(oThis);
}

function sc_calendar_calendar_novo_title_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_calendar_novo_start_time_onblur(oThis, iSeqRow) {
  do_ajax_calendar_calendar_novo_validate_start_time();
  scCssBlur(oThis);
}

function sc_calendar_calendar_novo_start_time_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_calendar_novo_hora_onblur(oThis, iSeqRow) {
  do_ajax_calendar_calendar_novo_validate_hora();
  scCssBlur(oThis);
}

function sc_calendar_calendar_novo_hora_onchange(oThis, iSeqRow) {
  nm_recarga_form('bloco_0', 0);
}

function sc_calendar_calendar_novo_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_calendar_calendar_novo_form" + pageNo).hide();
}
...
function scEventControl_onCalculator_recur_info() {
  if (!_scCalculatorControl["id_sc_field_recur_info"]) {
    ...
    do_ajax_calendar_calendar_novo_event_recur_info_onblur();
  }
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_start_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_calendar_calendar_novo_validate_start_date(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_end_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_calendar_novo_validate_end_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
